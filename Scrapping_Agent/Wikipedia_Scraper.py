import requests, wikipedia, re, random, wikipedia
...
# Smaller Models have hard time following prompt sometimes. This may lead to regex not finding any matches an throwing errors.
